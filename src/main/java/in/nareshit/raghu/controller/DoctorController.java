...
public class DoctorController {
	...
	/**
	 * 7. Read first name and check with service Return message back to UI
	 */
	@GetMapping("/checkFirstName")
	@ResponseBody
	public String validateFirstName(@RequestParam String firstname, @RequestParam Long id) {
		String message = "";
	...
	/**
	 * 8. Read last name and check with service Return message back to UI
	 */
	@GetMapping("/checkLastName")
	@ResponseBody
	public String validateLastName(@RequestParam String lastname, @RequestParam Long id) {
		String message = "";
	...
	/**
	 * 9. Read email and check with service Return message back to UI
	 */
	@GetMapping("/checkEmail")
	@ResponseBody
	public String validateEmail(@RequestParam String emailid, @RequestParam Long id) {
		String message = "";
	...
	/**
	 * 10. Read address and check with service Return message back to UI
	 */
	@GetMapping("/checkAddress")
	@ResponseBody
	public String validateAddress(@RequestParam String addr, @RequestParam Long id) {
		String message = "";
	...
	/**
	 * 10. Read mobile and check with service Return message back to UI
	 */
	@GetMapping("/checkMobile")
	@ResponseBody
	public String validateMobile(@RequestParam String Number, @RequestParam Long id) {
		String message = "";
	...
	/**
	 * 11. Read note and check with service Return message back to UI
	 */
	@GetMapping("/checkNote")
	@ResponseBody
	public String validateNote(@RequestParam String Info, @RequestParam Long id) {
		String message = "";
